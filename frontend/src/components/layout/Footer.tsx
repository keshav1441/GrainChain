      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-gray-400 text-sm max-w-md">
              AI-powered agricultural trade platform connecting farmers directly with institutional buyers while providing seamless access to finance.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link to="/finance" className="text-base text-gray-300 hover:text-white">
                  Finance
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8">
          <p className="text-base text-gray-400 text-center">
            &copy; 2024 GrainChain. All rights reserved. Built with ❤️ for farmers.
          </p>
        </div>
      </div>
    </footer>
